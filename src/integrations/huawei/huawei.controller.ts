...
export class HuaweiController {
  ...
  async getConnectConfig(@User() userId: string) {
  ...
  @ApiResponse({ status: 302, description: 'Redirect to client URL with result' })
  async callback(
  ...
  @ApiResponse({ status: 200, description: 'Huawei connection status returned' })
